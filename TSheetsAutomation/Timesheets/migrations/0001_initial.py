    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espo_processed', models.BooleanField()),
                ('jobcode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Timesheets.JobCode')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='regular_timesheet', to='Timesheets.User')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espo_processed', models.BooleanField()),
                ('jobcode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Timesheets.JobCode')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='manual_timesheet', to='Timesheets.User')),
            ],
        ),
    ]
